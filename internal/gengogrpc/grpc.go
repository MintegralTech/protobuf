...
func genService(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, service *protogen.Service) {
	...
	g.P("func New", poolName, " (consulAddr, serverName string, capacity int, timeout ", timePackage.Ident("Duration"), ") (", clientName, ", error)", " {")
	...
	g.P("func New", poolName, "V2 (path string) (", clientName, ", error)", " {")
	g.P("resolver, err := ", balancerPackage.Ident("NewRpcPoolWithConsul"), "(path)")
	g.P("if err != nil {")
	g.P("return nil, err")
	g.P("}")
	g.P("return &", unexport(poolName), "{resolver}, nil")
...
func genServerMethod(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, method *protogen.Method) string {
	...
	if !method.Desc.IsStreamingClient() && !method.Desc.IsStreamingServer() {
		...
		g.P("afterFun(&", metricsPackage.Ident("ServerMeta"), "{Err:err})")
		g.P("return nil, err")
		g.P("}")
